...
public class Aplicacion extends Application {
    ...
    public void start(final Stage stage) throws Exception {
        ...
        AplicacionOnKeyPressEventHandler aplicacionOnKeyPressEventHandler = new AplicacionOnKeyPressEventHandler(stage, contenedorPrincipal.getBarraDeMenu(), juego, contenedorPrincipal.getVistaTablero());
